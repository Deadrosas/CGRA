...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.unitCube, this.pyramid, this.cone, this.tangram, this.plane];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'unitCube': 0, 'Pyramid': 1, 'Cone': 2, 'Tangram': 3, 'Plane': 4 };
    ...
    initMaterials() {
        ...
        this.wood.setAmbient(0.5, 0.3, 0.1, 1.0);
        this.wood.setDiffuse(1, 0, 0, 1.0);
